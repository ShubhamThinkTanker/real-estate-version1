...
const EditChairman = () => {
  ...
  console.log(EditDatMessage, "fgerethfefefe");
              ...
              <Row>
                <Col md="6" sm="12">
                  <FormGroup>
                    ...
                    />
                    {errorsUSerEdit && errorsUSerEdit.name ? (
                      <div className="error">{errorsUSerEdit.name}</div>
                    ) : null}
                  </FormGroup>
                </Col>
                <Col md="6" sm="12">
                ...
                <Col md="6" sm="12">
                  <FormGroup>
                    ...
                    <Input
                      ...
                      onChange={(e) => onInputChange(e)}
                    />
                    {errorsUSerEdit && errorsUSerEdit.mobile_no ? (
                      <div className="error">{errorsUSerEdit.mobile_no}</div>
                    ) : null}
                  </FormGroup>
                </Col>
                <Col md="6" sm="12">
                  ...
                  <CustomInput
                    ...
                    onChange={(e) => onInputChange(e)}
                  />
                  {errorsUSerEdit && errorsUSerEdit.gender ? (
                    <div className="error">{errorsUSerEdit.gender}</div>
                  ) : null}
                </Col>
