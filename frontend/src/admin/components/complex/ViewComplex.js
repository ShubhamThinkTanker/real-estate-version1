...
const ViewComplex = () => {
  ...
  const getComplexRecordList = useSelector((state) => state.getidComplexRecord);
              ...
              <Row>
                <Col md="6" sm="12" className="mb-1">
                  ...
                  <Input
                    ...
                    disabled={true}
                    defaultValue={getComplexRecord.data.realestate_name}
                  />
                </Col>
                <Col md="6" sm="12" className="mb-1">
                  ...
                  <Input
                    ...
                    placeholder="Address"
                    disabled={true}
                    defaultValue={getComplexRecord.data.address}
                  />
                </Col>
                <Col md="6" sm="12" className="mb-1">
                  ...
                  <Input
                    ...
                    name="country"
                    disabled={true}
                    defaultValue={getComplexRecord.data.country}
                  >
                ...
                <Col md="6" sm="12" className="mb-1">
                  ...
                  <Input
                    ...
                    name="state"
                    disabled={true}
                    defaultValue={getComplexRecord.data.state}
                  >
                ...
                <Col md="6" sm="12" className="mb-1">
                  ...
                  <Input
                    ...
                    name="city"
                    disabled={true}
                    defaultValue={getComplexRecord.data.city}
                  >
